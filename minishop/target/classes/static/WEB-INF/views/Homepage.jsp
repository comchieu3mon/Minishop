							...
							<div class="dropdown">
								...
								<div class="dropdown-menu">
									<c:forEach items="${ listCategory }" var="category">
										<a class="dropdown-item" href="./category/${ category.getCategory_name() }">${ category.getCategory_name() }</a>
									</c:forEach>
								</div>
							</div>
						</li>
				...
				<div class="col-lg-3 col-md-6 mb-4 margin-top wow bounce">
					<div class="card h-100">
						<img class="card-img-top"
							src='<c:url value="${ product.getProduct_image() }"></c:url>'
							alt="">
						<div class="card-body">
						...
						<div class="card-footer">
							<a href="./detail/${product.getProduct_id()}"
